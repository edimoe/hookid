...
local oxygenTankId = 105
local oxygenTankName = "Oxygen Tank"

local oxygenTankDropdown = Reg("oxytype", misc:Dropdown({
    ...
    Callback = function(value)
        if value == "Advanced Oxygen Tank" then
            oxygenTankId = 575
            oxygenTankName = "Advanced Oxygen Tank"
        else
            oxygenTankId = 105
            oxygenTankName = "Oxygen Tank"
        end
    end
}))
...
local ttank = Reg("infox", misc:Toggle({
    ...
    Callback = function(state)
        if state then
            ...
            pcall(function()
                RF_EquipOxygenTank:InvokeServer(oxygenTankId)
            end)
            WindUI:Notify({ Title = "Oxygen Tank Equipped", Content = oxygenTankName .. " equipped.", Duration = 3, Icon = "check" })
        else
